...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ModuleA_Category/ModuleA_Category.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ModuleB/ModuleB.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ModuleB_Category/ModuleB_Category.framework"
fi
